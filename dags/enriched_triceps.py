...
with ((dag)):
    ...
    with TaskGroup(group_id="enriched") as enriched:
        ...
        enriched_participant_index >> enriched_consultation >> [enriched_general_information_consultation, enriched_appointment_information] >> [
          enriched_laboratory_results, enriched_pathology_results, enriched_general_information_consultation,
