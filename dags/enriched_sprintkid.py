    ...
    "steps": [
        {
            ...
            "datasets": [
                {"dataset_id": "enriched_sprintkid_case_confirmation"                       , "cluster_type": "small" , "run_type": "initial", "pass_date": True, "dependencies": ["enriched_sprintkid_respiratory_pathogen_diagnostics"]},
                {"dataset_id": "enriched_sprintkid_hospital_data"                           , "cluster_type": "medium", "run_type": "initial", "pass_date": True, "dependencies": ["enriched_sprintkid_respiratory_pathogen_diagnostics"]},
                {"dataset_id": "enriched_sprintkid_hospital_data_previous_visit"            , "cluster_type": "medium", "run_type": "initial", "pass_date": True, "dependencies": ["enriched_sprintkid_hospital_data"]},
                ...
                {"dataset_id": "enriched_sprintkid_live_region_v20_import_template_balanced", "cluster_type": "medium", "run_type": "initial", "pass_date": True, "dependencies": ["enriched_sprintkid_live_region_v20_import_template"]},
                {"dataset_id": "enriched_sprintkid_live_region_v20_import_template"         , "cluster_type": "small" , "run_type": "initial", "pass_date": True, "dependencies": ["enriched_sprintkid_participant_index", "enriched_sprintkid_stream_2_aefi_screening", "enriched_sprintkid_respiratory_pathogen_diagnostics", "enriched_sprintkid_patient_data", "enriched_sprintkid_hospital_data", "enriched_sprintkid_hospital_data_previous_visit", "enriched_sprintkid_case_confirmation", "enriched_sprintkid_treatments", "enriched_sprintkid_stream_34_screening", "enriched_sprintkid_xray_and_blood_diagnostics"]},
                ...
                {"dataset_id": "enriched_sprintkid_treatments"                              , "cluster_type": "medium", "run_type": "default", "pass_date": True, "dependencies": ["enriched_sprintkid_hospital_data", "enriched_sprintkid_respiratory_pathogen_diagnostics"]},
                {"dataset_id": "enriched_sprintkid_xray_and_blood_diagnostics"              , "cluster_type": "medium", "run_type": "initial", "pass_date": True, "dependencies": ["enriched_sprintkid_hospital_data", "enriched_sprintkid_respiratory_pathogen_diagnostics"]},
