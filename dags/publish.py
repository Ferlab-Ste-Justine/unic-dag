...
os_prod_url = None # remove after demo
os_port = None # remove after demo
...
for env in PostgresEnv:
    ...
    * Paramètre `version_to_publish` (optional) : date version dans released à publier dans published.
    * Paramètre `release_id` (optional) : release id of opensearch index
    ...
    with DAG(
            ...
            params={
                ...
                "version_to_publish": Param("", type="string", description="(Optional) Date to publish. If not specified, will take most recent release. Ex: 2001-01-01"),
