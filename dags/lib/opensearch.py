...
os_prod_credentials_secret = 'opensearch-prod-dags-credentials'
os_prod_cert_secret = 'opensearch-prod-ca-certificate'
...
os_qa_cert_secret = 'opensearch-qa-ca-certificate'
