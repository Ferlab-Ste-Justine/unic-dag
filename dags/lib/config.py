...
os_ca_path = "/tmp/es-ca/" #cert path is currently hardcoded in os_yml file. Do not change.
os_ca_cert = Variable.get('opensearch_ca_certificate', None)
os_ca_filename = "ca.crt"
os_yml = 's3a://spark-prd/yml/pod-template-os-cert.yml' # currently hardcoded in spark-core-yellow config. Do not change.
